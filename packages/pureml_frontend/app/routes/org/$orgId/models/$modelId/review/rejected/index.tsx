...
import { fetchModelReview } from "~/routes/api/models.server";
...
export async function loader({ params, request }: any) {
  ...
  const allReview = await fetchModelReview(
    session.get("orgId"),
    params.modelId,
    ...
    <div id="modelsReview">
      ...
      <div className="flex justify-center w-full">
        <div className="bg-slate-50 flex flex-col h-screen overflow-hidden w-full 2xl:max-w-screen-2xl">
          <ReviewTabbar intent="modelReviewTab" tab="rejected" />
