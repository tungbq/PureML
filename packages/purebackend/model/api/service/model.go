...
func (api *Api) GetModel(request *models.Request) *models.Response {
	...
	return models.NewDataResponse(http.StatusOK, model, "Model successfully retrieved")
}
...
func (api *Api) CreateModel(request *models.Request) *models.Response {
	...
	var modelReadmeData *commonmodels.ReadmeRequest
	if modelReadme == nil {
		modelReadmeData = &commonmodels.ReadmeRequest{
			FileType: "markdown",
			Content:  "",
		}
	} else {
