	...
	scenarios := []test.ApiScenario{
		{
			...
			Url:            "/api/org/" + test.ValidAdminUserOrgUuid.String() + "/model/Demo%20Model/branch/dev/version",
			ExpectedStatus: 401,
		...
		},
		{
			...
			Url:    "/api/org/" + test.InvalidOrgUuidString + "/model/Demo%20Model/branch/dev/version",
			RequestHeaders: map[string]string{
		...
		},
		{
			...
			Method: http.MethodPost,
			Url:    "/api/org/" + test.ValidNoOrgUuid.String() + "/model/Demo%20Model/branch/dev/version",
			RequestHeaders: map[string]string{
				"Authorization": test.ValidAdminToken,
			},
			ExpectedStatus: 404,
		...
		},
		{
			...
			Method: http.MethodGet,
			Url:    "/api/org/" + test.ValidAdminUserOrgUuid.String() + "/model/NoModel/branch/dev/version",
			RequestHeaders: map[string]string{
				"Authorization": test.ValidAdminToken,
			},
			ExpectedStatus: 404,
		...
		},
		{
			...
			Method: http.MethodGet,
			Url:    "/api/org/" + test.ValidAdminUserOrgUuid.String() + "/model/Demo%20Model/branch/nobranch/version",
			RequestHeaders: map[string]string{
				"Authorization": test.ValidAdminToken,
			},
			ExpectedStatus: 404,
	...
	scenarios := []test.ApiScenario{
		{
			Name:           "get specific version of model branch + unauthorized",
			Method:         http.MethodGet,
			Url:            "/api/org/" + test.ValidAdminUserOrgUuid.String() + "/model/Demo%20Model/branch/dev/version/v1",
			ExpectedStatus: 401,
			ExpectedContent: []string{
				`Authentication token required`,
			},
		...
		},
		{
			...
			Method: http.MethodPost,
			Url:    "/api/org/" + test.InvalidOrgUuidString + "/model/Demo%20Model/branch/dev/version/v1",
			RequestHeaders: map[string]string{
				"Authorization": test.ValidAdminToken,
			},
			ExpectedStatus: 400,
		...
		},
		{
			...
			Method: http.MethodPost,
			Url:    "/api/org/" + test.ValidNoOrgUuid.String() + "/model/Demo%20Model/branch/dev/version/v1",
			RequestHeaders: map[string]string{
				"Authorization": test.ValidAdminToken,
			},
			ExpectedStatus: 404,
		...
		},
		{
			...
			Method: http.MethodGet,
			Url:    "/api/org/" + test.ValidAdminUserOrgUuid.String() + "/model/NoModel/branch/dev/version/v1",
			RequestHeaders: map[string]string{
				"Authorization": test.ValidAdminToken,
			},
			ExpectedStatus: 404,
		...
		},
		{
			...
			Method: http.MethodGet,
			Url:    "/api/org/" + test.ValidAdminUserOrgUuid.String() + "/model/Demo%20Model/branch/dev/version/v2",
			RequestHeaders: map[string]string{
				"Authorization": test.ValidAdminToken,
			},
			ExpectedStatus: 404,
	...
	scenarios := []test.ApiScenario{
		{
			...
			Method:         http.MethodPost,
			Url:            "/api/org/" + test.ValidAdminUserOrgUuid.String() + "/model/Demo%20Model/branch/dev/hash-status",
			ExpectedStatus: 401,
			ExpectedContent: []string{
				`Authentication token required`,
			},
		...
		},
		{
			...
			Method: http.MethodPost,
			Url:    "/api/org/" + test.InvalidOrgUuidString + "/model/Demo%20Model/branch/dev/hash-status",
			RequestHeaders: map[string]string{
				"Authorization": test.ValidAdminToken,
			},
			ExpectedStatus: 400,
		...
		},
		{
			...
			Method: http.MethodPost,
			Url:    "/api/org/" + test.ValidNoOrgUuid.String() + "/model/Demo%20Model/branch/dev/hash-status",
			RequestHeaders: map[string]string{
		...
		},
		{
			...
			Method: http.MethodPost,
			Url:    "/api/org/" + test.ValidAdminUserOrgUuid.String() + "/model/noModel/branch/dev/hash-status",
			RequestHeaders: map[string]string{
				"Authorization": test.ValidUserToken,
			},
			ExpectedStatus: 404,
		...
		},
		{
			...
			Method: http.MethodPost,
			Url:    "/api/org/" + test.ValidAdminUserOrgUuid.String() + "/model/Demo%20Model/branch/nobranch/hash-status",
			RequestHeaders: map[string]string{
				"Authorization": test.ValidAdminToken,
			},
			Body: strings.NewReader(`{
	...
	scenarios := []test.ApiScenario{
		{
			...
			Method:         http.MethodPost,
			Url:            "/api/org/" + test.ValidAdminUserOrgUuid.String() + "/model/Demo%20Model/branch/dev/register",
			ExpectedStatus: 401,
			ExpectedContent: []string{
				`Authentication token required`,
			},
		...
		},
		{
			...
			Method: http.MethodPost,
			Url:    "/api/org/" + test.InvalidOrgUuidString + "/model/Demo%20Model/branch/dev/register",
			RequestHeaders: map[string]string{
				"Authorization": test.ValidAdminToken,
			},
			ExpectedStatus: 400,
		...
		},
		{
			...
			Method: http.MethodPost,
			Url:    "/api/org/" + test.ValidNoOrgUuid.String() + "/model/Demo%20Model/branch/dev/register",
			RequestHeaders: map[string]string{
				"Authorization": test.ValidUserToken,
			},
			ExpectedStatus: 404,
		...
		},
		{
			...
			Method: http.MethodPost,
			Url:    "/api/org/" + test.ValidAdminUserOrgUuid.String() + "/model/noModel/branch/dev/register",
			RequestHeaders: map[string]string{
				"Authorization": test.ValidUserToken,
			},
			ExpectedStatus: 404,
		...
		},
		{
			...
			Method: http.MethodPost,
			Url:    "/api/org/" + test.ValidAdminUserOrgUuid.String() + "/model/Demo%20Model/branch/nobranch/register",
			RequestHeaders: map[string]string{
				"Authorization": test.ValidUserToken,
			},
			ExpectedStatus: 404,
		...
		},
		{
			...
			Method: http.MethodPost,
			Url:    "/api/org/" + test.ValidAdminUserOrgUuid.String() + "/model/Demo%20Model/branch/main/register",
			RequestHeaders: map[string]string{
				"Authorization": test.ValidAdminToken,
