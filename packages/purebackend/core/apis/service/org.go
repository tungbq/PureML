...
func BindOrgApi(app core.App, rg *echo.Group) {
	...
	rg.GET("/org/:orgId/public/model", api.DefaultHandler(GetOrgAllPublicModels), orgmiddlewares.ValidateOrg(api.app))
	rg.GET("/org/:orgId/public/dataset", api.DefaultHandler(GetOrgAllPublicDatasets), orgmiddlewares.ValidateOrg(api.app))
	orgGroup := rg.Group("/org", authmiddlewares.RequireAuthContext)
	orgGroup.GET("/id/:orgId", api.DefaultHandler(GetOrgByID), orgmiddlewares.ValidateOrg(api.app))
	orgGroup.POST("/create", api.DefaultHandler(CreateOrg))
	orgGroup.POST("/:orgId/update", api.DefaultHandler(UpdateOrg), orgmiddlewares.ValidateOrg(api.app))
}
...
func (api *Api) GetOrgByHandle(request *models.Request) *models.Response {
	...
	if organization == nil {
		...
		response = models.NewDataResponse(http.StatusOK, organization, "Organization details")
	}
	return response
}
...
func (api *Api) CreateOrg(request *models.Request) *models.Response {
	...
	response := models.NewDataResponse(http.StatusOK, org, "Organization created")
	return response
}
...
func (api *Api) UpdateOrg(request *models.Request) *models.Response {
	...
	return models.NewDataResponse(http.StatusOK, updatedOrg, "Organization updated")
}
