	...
	scenarios := []tests.ApiScenario{
		{
			...
			Method:         http.MethodGet,
			Url:            "/api/org/" + ValidAdminUserOrgUuid.String() + "/model/all",
			ExpectedStatus: 401,
			ExpectedContent: []string{
		...
		},
		{
			...
			Url:    "/api/org/" + InvalidOrgUuidString + "/model/all",
			RequestHeaders: map[string]string{
				"Authorization": ValidAdminToken,
			},
			ExpectedStatus: 400,
		...
		},
		{
			...
			Method: http.MethodPost,
			Url:    "/api/org/" + ValidNoOrgUuid.String() + "/model/all",
			RequestHeaders: map[string]string{
				"Authorization": ValidAdminToken,
			},
			ExpectedStatus: 404,
	...
	scenarios := []tests.ApiScenario{
		{
			...
			Method:         http.MethodGet,
			Url:            "/api/org/" + ValidAdminUserOrgUuid.String() + "/model/Demo%20Model",
			ExpectedStatus: 401,
			ExpectedContent: []string{
				`Authentication token required`,
			},
		...
		},
		{
			...
			Method: http.MethodGet,
			Url:    "/api/org/" + InvalidOrgUuidString + "/model/Demo%20Model",
			RequestHeaders: map[string]string{
				"Authorization": ValidAdminToken,
			},
			ExpectedStatus: 400,
		...
		},
		{
			...
			Method: http.MethodGet,
			Url:    "/api/org/" + ValidNoOrgUuid.String() + "/model/Demo%20Model",
			RequestHeaders: map[string]string{
				"Authorization": ValidUserToken,
			},
			ExpectedStatus: 404,
		...
		},
		{
			...
			Method: http.MethodGet,
			Url:    "/api/org/" + ValidAdminUserOrgUuid.String() + "/model/No%20Model",
			RequestHeaders: map[string]string{
				"Authorization": ValidAdminToken,
			},
			ExpectedStatus: 404,
	...
	scenarios := []tests.ApiScenario{
		{
			Name:           "create model + unauthorized",
			Method:         http.MethodPost,
			Url:            "/api/org/" + ValidAdminUserOrgUuid.String() + "/model/test/create",
			ExpectedStatus: 401,
			ExpectedContent: []string{
				`Authentication token required`,
			},
		...
		},
		{
			Name:   "create model + valid token + invalid org uuid",
			Method: http.MethodPost,
			Url:    "/api/org/" + InvalidOrgUuidString + "/model/test/create",
			RequestHeaders: map[string]string{
				"Authorization": ValidAdminToken,
			},
			ExpectedStatus: 400,
		...
		},
		{
			Name:   "create model + valid token + org not found",
			Method: http.MethodPost,
			Url:    "/api/org/" + ValidNoOrgUuid.String() + "/model/test/create",
			RequestHeaders: map[string]string{
				"Authorization": ValidUserToken,
			},
			ExpectedStatus: 404,
		...
		},
		{
			...
			Method: http.MethodPost,
			Url:    "/api/org/" + ValidAdminUserOrgUuid.String() + "/model/Demo%20Model/create",
			RequestHeaders: map[string]string{
				"Authorization": ValidAdminToken,
			},
