...
func (api *Api) CreateDatasetReview(request *models.Request) *models.Response {
	...
	return models.NewDataResponse(http.StatusOK, createdReview, "Dataset review created")
}
...
func (api *Api) UpdateDatasetReview(request *models.Request) *models.Response {
	...
	return models.NewDataResponse(http.StatusOK, updatedDbReview, "Dataset review updated")
}
