...
func (api *Api) GetDataset(request *models.Request) *models.Response {
	...
	return models.NewDataResponse(http.StatusOK, dataset, "Dataset successfully retrieved")
}
...
func (api *Api) CreateDataset(request *models.Request) *models.Response {
	...
	var datasetReadmeData *commonmodels.ReadmeRequest
	if datasetReadme == nil {
		datasetReadmeData = &commonmodels.ReadmeRequest{
			FileType: "markdown",
			Content:  "",
		}
	} else {
