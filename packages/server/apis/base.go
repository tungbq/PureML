...
func InitApi(app *core.App) (*echo.Echo, error) {
	...
	rg := e.Group("/api")
	api := service.Api{app: app}

	//Health API
	rg.GET("/health", api.DefaultHandler(api.HealthCheck))
	...
	//Org APIs
	rg.GET("/public/model", handler.DefaultHandler(service.GetAllPublicModels))
	rg.GET("/public/dataset", handler.DefaultHandler(service.GetAllPublicDatasets))
	rg.GET("/org/handle/:orgHandle", handler.DefaultHandler(service.GetOrgByHandle))
	rg.GET("/org/:orgId/public/model", handler.DefaultHandler(service.GetOrgAllPublicModels), middlewares.ValidateOrg)
	rg.GET("/org/:orgId/public/dataset", handler.DefaultHandler(service.GetOrgAllPublicDatasets), middlewares.ValidateOrg)
